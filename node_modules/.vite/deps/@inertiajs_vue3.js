...
function template(string, options, guard) {
  ...
  string = toString_default(string);
  options = assignWith_default({}, options, settings2, customDefaultsAssignIn_default);
  var imports = assignWith_default({}, options.imports, settings2.imports, customDefaultsAssignIn_default), importsKeys = keys_default(imports), importsValues = baseValues_default(imports, importsKeys);
  ...
  methods: {
    ...
    addTitleElement(elements) {
      if (this.title && !elements.find((tag) => tag.startsWith("<title"))) {
        elements.push(`<title ${this.provider.preferredAttribute()}>${escape_default(this.title)}</title>`);
      }
      return elements;
    },
    renderNodes(nodes) {
