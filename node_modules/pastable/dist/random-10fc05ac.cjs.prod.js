...
var misc = require('./misc-a5381864.cjs.prod.js');
...
const pickDefined = (obj, paths) => pickBy(obj, paths, (_key, value) => misc.isDefined(value));
 ...
 */
function hash(value) {
  return JSON.stringify(value, (_, val) => misc.isObjectLiteral(val) ? sortObjectKeys(val) : val);
}
...
const mergeProps = (left, right) => {
  ...
  for (const key in result) {
    if (typeof left[key] === "function" && typeof right[key] === "function") {
      result[key] = misc.callAll(left[key], right[key]);
    }
  }
  return result;
};
...
function pickMultipleUnique(arr, n, excluded = []) {
  ...
  const pickable = misc.exclude(arr, excluded);
  const result = [];
  let picked;
  while (n--) {
    picked = pickOne(misc.exclude(pickable, result));
    result.push(picked);
  }
  return result;
}
...
const makeArrayOfRandIn = (x = 5, y) => misc.makeArrayOf(getRandomIntIn(x, y));

exports.areRectsIntersecting = areRectsIntersecting;
...
exports.getClosestNbIn = getClosestNbIn;
exports.getCommonKeys = getCommonKeys;
exports.getPageCount = getPageCount;
exports.getRandomFloatIn = getRandomFloatIn;
exports.getRandomIntIn = getRandomIntIn;
exports.getRandomPercent = getRandomPercent;
exports.getRandomString = getRandomString;
exports.getSelf = getSelf;
exports.getSum = getSum;
exports.getTotalPages = getTotalPages;
exports.groupBy = groupBy;
exports.groupIn = groupIn;
exports.hasShallowDiff = hasShallowDiff;
exports.hasShallowDiffInCommonKeys = hasShallowDiffInCommonKeys;
exports.hash = hash;
exports.kebabToCamel = kebabToCamel;
exports.keys = keys;
exports.limit = limit;
exports.limitStr = limitStr;
exports.makeArrayOfRandIn = makeArrayOfRandIn;
exports.makeInstance = makeInstance;
exports.makeSelfGetters = makeSelfGetters;
exports.mapper = mapper;
exports.mergeProps = mergeProps;
exports.omit = omit;
exports.parseStringAsBoolean = parseStringAsBoolean;
exports.pick = pick;
exports.pickBy = pickBy;
exports.pickDefined = pickDefined;
exports.pickMultipleUnique = pickMultipleUnique;
exports.pickOne = pickOne;
exports.pickOneBut = pickOneBut;
exports.pickOneInEnum = pickOneInEnum;
exports.prop = prop;
...
exports.sortObjKeysFromArray = sortObjKeysFromArray;
